"use strict";(()=>{var Q=Object.defineProperty,X=Object.defineProperties;var Z=Object.getOwnPropertyDescriptors;var w=Object.getOwnPropertySymbols;var B=Object.prototype.hasOwnProperty,U=Object.prototype.propertyIsEnumerable;var $=(r,t,e)=>t in r?Q(r,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):r[t]=e,p=(r,t)=>{for(var e in t||(t={}))B.call(t,e)&&$(r,e,t[e]);if(w)for(var e of w(t))U.call(t,e)&&$(r,e,t[e]);return r},C=(r,t)=>X(r,Z(t));var y=(r,t)=>{var e={};for(var n in r)B.call(r,n)&&t.indexOf(n)<0&&(e[n]=r[n]);if(r!=null&&w)for(var n of w(r))t.indexOf(n)<0&&U.call(r,n)&&(e[n]=r[n]);return e};var u=(r,t,e)=>$(r,typeof t!="symbol"?t+"":t,e);var b=(r,t,e)=>new Promise((n,i)=>{var s=c=>{try{l(e.next(c))}catch(f){i(f)}},o=c=>{try{l(e.throw(c))}catch(f){i(f)}},l=c=>c.done?n(c.value):Promise.resolve(c.value).then(s,o);l((e=e.apply(r,t)).next())});var v=r=>typeof r=="object"&&!Array.isArray(r)&&r!==null,E=(r,t)=>Object.prototype.hasOwnProperty.call(r,t),M=r=>Array.isArray(r)?r:[r];var W=(r,t)=>r.slice(0,Math.max(0,t)),x=r=>(r.split("-").length>1?r.split("-"):r.split("_")).map((e,n)=>(n>0&&(e=e.charAt(0).toUpperCase()+e.slice(1)),e)).join(""),j=(r,t)=>{let e=new Set(t);return r.getAttributeNames().every(n=>!e.has(n))},N=(r,t)=>!t.includes(r.type),T=r=>typeof r=="string"&&r.length>0,G=r=>b(null,null,function*(){let e=yield(yield fetch(r)).text();try{return JSON.parse(e)}catch(n){throw console.error(n),new Error("Failed to parse JSON")}});var K={CDN_JS_URL:"https://cdn.jsdelivr.net/npm/autofill-js@2.0.5/dist/js/autofill.min.js",CDN_CSS_URL:"https://cdn.jsdelivr.net/npm/autofill-js@2.0.5/dist/css/autofill.min.css",DEV_HOSTS:["127.0.0.1:5100","127.0.0.1:5101"]};var I=class r{constructor(t,e,n){u(this,"autofill",t);u(this,"configManager",e);u(this,"domForms",n)}init(){let t=document.createElement("link");t.setAttribute("rel","stylesheet"),t.setAttribute("type","text/css"),t.onload=this.show.bind(this),t.setAttribute("href",r.cssLink()),document.querySelectorAll("head")[0].append(t)}show(){let t=this.autofill;document.querySelector("body").style.paddingTop="35px";let e=`
